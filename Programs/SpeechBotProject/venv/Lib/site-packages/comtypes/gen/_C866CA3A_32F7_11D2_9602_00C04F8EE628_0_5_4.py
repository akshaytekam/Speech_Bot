...
__all__ = [
    'DISPID_SVEViseme', 'eWORDTYPE_DELETED', 'SPEI_SR_BOOKMARK',
    'SRSInactive', 'SPEVENT', 'SPBO_PAUSE', 'SVP_14',
    'DISPID_SDKSetStringValue', 'DISPID_SPISaveToMemory',
    'DISPID_SOTsItem', 'SFTInput', 'SAFT12kHz16BitMono',
    'SPCT_SUB_COMMAND', 'SECFIgnoreCase',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPAsCount',
    'SP_VISEME_5', 'DISPID_SPELexicalForm',
    'IInternetSecurityManager', 'SPVISEMES',
    'DISPID_SRCRetainedAudio', 'SVEAudioLevel', 'DISPID_SLGetWords',
    'ISpeechRecognizer', 'eLEXTYPE_PRIVATE7', 'SREBookmark',
    'eLEXTYPE_PRIVATE10', 'eLEXTYPE_PRIVATE17', 'SPPS_Verb',
    'DISPID_SpeechVoiceStatus', 'DISPID_SGRSTWeight',
    'DISPID_SRRAlternates', 'eLEXTYPE_RESERVED9',
    'SPWORDPRONUNCIATION', 'DISPID_SABufferNotifySize',
    'SpObjectTokenCategory', 'SVEWordBoundary',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVP_7', 'SINoise',
    'SPEVENTSOURCEINFO', 'SPAR_Low', 'ISpeechRecoGrammar',
    ...
    'DISPID_SOTRemove', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechFileStream', 'DISPID_SLWs_NewEnum',
    'SpeechEngineConfidence', 'DISPID_SGRsAdd', 'SECFDefault',
    'SRAORetainAudio', 'SPEI_SR_PRIVATE', 'DISPID_SCSBaseStream',
    'DISPID_SOTCGetDataKey', 'SPSUnknown', 'SPEI_UNDEFINED',
    'eLEXTYPE_VENDORLEXICON', 'SAFT22kHz16BitStereo',
    'ISpeechRecognizerStatus', 'ISpResourceManager', 'SFTSREngine',
    'SDKLCurrentConfig', 'DISPID_SGRAddResource',
    'DISPID_SRRPhraseInfo', 'SVP_6', 'SPBO_NONE', 'SPFM_NUM_MODES',
    'DISPID_SRGReset', 'DISPID_SPIEnginePrivateData', 'SpAudioFormat',
    'eLEXTYPE_PRIVATE8', 'ISpStream', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRGIsPronounceable', 'SP_VISEME_8',
    'Speech_StreamPos_RealTime', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRSetPropertyNumber', 'SpObjectToken',
    'DISPID_SGRsDynamic', 'SPEI_RECO_OTHER_CONTEXT', 'SDTAlternates',
    'DISPID_SRCEStartStream', 'SAFT16kHz16BitStereo',
    'SAFTGSM610_8kHzMono', 'SGRSTTWord', 'SDA_Consume_Leading_Spaces',
    'DISPID_SABIMinNotification', 'DISPID_SRCreateRecoContext',
    'SpeechGrammarTagUnlimitedDictation', 'SECFIgnoreKanaType',
    'SpeechVoiceCategoryTTSRate', 'SECFIgnoreWidth', 'SPPHRASERULE',
    'STCAll', 'SREPrivate', 'SRATopLevel', 'STCInprocServer',
    'SAFTADPCM_22kHzStereo', 'SpeechEmulationCompareFlags',
    'SPWF_INPUT', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPRuleName', 'SPADAPTATIONRELEVANCE',
    'SPRECOGNIZERSTATUS', 'DISPID_SRGSetTextSelection',
    'SpeechCategoryRecoProfiles', 'ISpRecoGrammar',
    'DISPID_SDKGetlongValue', 'ISpeechTextSelectionInformation',
    'eLEXTYPE_RESERVED7', 'DISPID_SBSSeek', 'SP_VISEME_11',
    'SAFTExtendedAudioFormat', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVSyncronousSpeakTimeout', 'SP_VISEME_20',
    'DISPID_SVSpeakCompleteEvent', 'SVF_Emphasis',
    'SpeechWordPronounceable', 'DISPID_SABIBufferSize',
    'DISPID_SpeechRecognizerStatus', 'SPEI_RESERVED5',
    'ISpeechPhraseRules', 'SPRS_ACTIVE',
    'DISPID_SPEAudioStreamOffset', 'eLEXTYPE_LETTERTOSOUND',
    'SPTEXTSELECTIONINFO', 'SPCT_SUB_DICTATION', 'SAFT44kHz16BitMono',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVEventInterests', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPRsCount', 'SpeechCategoryPhoneConverters',
    'DISPID_SRRecognizer', 'DISPID_SPRNumberOfElements',
    'DISPID_SRRAudio', 'SpeechCategoryAudioOut', 'SRTEmulated',
    'SAFTNoAssignedFormat', 'SPAS_STOP', 'DISPID_SpeechDataKey',
    'SPEI_MIN_SR', 'DISPID_SBSRead', 'ISpNotifySink',
    'SECNormalConfidence', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRGCommit', 'DISPID_SRCERecognizerStateChange',
    'SDTProperty', 'SAFTGSM610_44kHzMono', 'DISPID_SPRuleId',
    'SpeechTokenContext', 'DISPID_SLWPronunciations',
    'ISequentialStream', 'DISPID_SVSLastResult',
    'DISPID_SPAPhraseInfo', 'ISpRecoCategory', 'SP_VISEME_12',
    'SPAS_RUN', 'SPDKL_LocalMachine', 'SSFMCreateForWrite',
    'DISPID_SOTSetId', 'DISPID_SPCIdToPhone', 'SVESentenceBoundary',
    'ISpXMLRecoResult', 'DISPID_SRGCmdLoadFromMemory',
    'SPEI_VOICE_CHANGE', 'eLEXTYPE_PRIVATE20', 'SPEI_RECOGNITION',
    'DISPID_SRCERecognitionForOtherContext', 'SVPAlert',
    'DISPID_SLAddPronunciation', 'SPSHT_Unknown', 'eLEXTYPE_PRIVATE4',
    'SAFTText', 'SVP_9', 'Speech_Max_Word_Length',
    'SpeechStreamFileMode', 'SPPS_Modifier', 'DISPID_SRStatus',
    'DISPID_SGRSTsItem', 'SP_VISEME_18', 'eLEXTYPE_PRIVATE13',
    'SGDSActive', 'SpeechAllElements', 'SP_VISEME_1',
    'DISPID_SpeechAudio', 'SPEI_PHONEME', 'SpMMAudioOut',
    'SAFTADPCM_8kHzMono', 'SPSSuppressWord', 'SpPhraseInfoBuilder',
    'SpFileStream', 'DISPID_SPEEngineConfidence',
    'DISPID_SGRSTransitions', 'DISPID_SpeechMMSysAudio',
    'DISPID_SMSADeviceId', 'SECFNoSpecialChars',
    'ISpeechLexiconPronunciation', 'SpInProcRecoContext',
    'DISPID_SpeechCustomStream', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechLoadOption',
    'DISPID_SDKCreateKey', 'SAFTADPCM_22kHzMono',
    'SPINTERFERENCE_LATENCY_WARNING', 'STSF_LocalAppData',
    'SpeechRuleState', 'DISPID_SVResume', 'SPWT_LEXICAL',
    'SREInterference', 'SSSPTRelativeToCurrentPosition',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SpeechPhraseBuilder',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPPEngineConfidence',
    'DISPID_SLPsItem', 'SpeechEngineProperties', 'eLEXTYPE_PRIVATE11',
    'SVP_13', 'SPPS_Noun', 'DISPID_SGRsCommit',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVDisplayUI',
    'DISPID_SRDisplayUI', 'SRSEIsSpeaking',
    'DISPID_SpeechXMLRecoResult', 'ISpPhoneConverter',
    'SDKLDefaultLocation', 'DISPID_SPIGrammarId', 'SDTAudio',
    'DISPID_SOTCDefault', 'DISPID_SPPConfidence',
    'SPFM_OPEN_READONLY', 'SVPNormal', 'SPPS_RESERVED3',
    'SPPHRASEELEMENT', 'SPGS_ENABLED', 'DISPID_SRGetPropertyNumber',
    'SPSHORTCUTTYPE', 'DISPID_SLGetGenerationChange', 'DISPID_SGRId',
    'Speech_Default_Weight', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpMemoryStream', 'SpShortcut', 'SPPS_Function',
    'SPPS_SuppressWord', 'SVSFDefault',
    'SpeechDictationTopicSpelling', 'DISPID_SPARecoResult',
    'DISPID_SpeechObjectTokens', 'DISPID_SVSLastBookmark',
    'DISPID_SRGetFormat', 'DISPID_SVGetAudioInputs',
    'DISPID_SRIsUISupported', 'SpNullPhoneConverter', 'SVSFParseSapi',
    'SVEPhoneme', 'SPBOOKMARKOPTIONS', 'DISPID_SAEventHandle',
    'SVP_15', 'tagSTATSTG', 'SAFT32kHz16BitStereo', 'SVP_1',
    'SECLowConfidence', 'SPFILEMODE', 'DISPID_SRCEInterference',
    'SPRST_NUM_STATES', 'ISpeechXMLRecoResult', 'SLODynamic',
    'IStream', 'DISPID_SVVoice', 'SPEI_END_SR_STREAM', 'SPRST_ACTIVE',
    'DISPID_SVEBookmark', 'DISPID_SRCESoundEnd',
    'SGLexicalNoSpecialChars', 'SWTDeleted', 'ISpEventSink',
    'SPVPRIORITY', 'ISpMMSysAudio', 'SRERecognition',
    'DISPID_SpeechPhoneConverter', 'SPEI_END_INPUT_STREAM', 'SRARoot',
    'DISPID_SRGId', 'ISpeechPhraseProperties', 'DISPID_SRCEEndStream',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechWaveFormatEx',
    'SPWORD', 'SRSActiveAlways', '_ISpeechRecoContextEvents',
    'ISpeechPhoneConverter', 'DISPID_SLWType', 'SGSEnabled',
    'DISPID_SpeechPhraseProperty', 'SPSEMANTICFORMAT', 'SPRECOSTATE',
    'DISPID_SPAStartElementInResult', 'SpCompressedLexicon',
    'DISPID_SPIRule', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRSTPropertyName', 'DISPID_SPEs_NewEnum',
    'ISpeechVoiceStatus', 'DISPID_SPPId', 'SRAInterpreter',
    'DISPID_SDKSetLongValue', 'SPINTERFERENCE_NOSIGNAL',
    'SRERecoOtherContext', 'DISPID_SBSFormat', 'DISPID_SWFEChannels',
    'ISpeechPhraseReplacement', 'DISPID_SRRSaveToMemory',
    'DISPID_SPIGetText', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechVisemeFeature', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPEI_ADAPTATION', 'ISpeechRecoResult2',
    'DISPID_SRSetPropertyString', 'SPEI_TTS_AUDIO_LEVEL',
    'SpeechSpecialTransitionType', 'DISPID_SRGetRecognizers',
    'SPWAVEFORMATTYPE', 'SPINTERFERENCE_TOOLOUD', 'SGRSTTWildcard',
    'DISPID_SPRFirstElement', '_SPAUDIOSTATE', 'SPCT_COMMAND',
    'SSTTDictation', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPIAudioStreamPosition', 'ISpRecoGrammar2',
    'ISpeechPhraseAlternate', 'SGSDisabled',
    'ISpeechPhraseReplacements', 'SpeechGrammarWordType',
    'DISPID_SOTDisplayUI', 'ISpeechAudioStatus',
    'SpeechRecoContextState', 'SPRS_INACTIVE', 'SPSMF_UPS',
    'SpeechDisplayAttributes', 'ISpeechGrammarRuleState',
    'DISPID_SGRAddState', 'ISpeechFileStream', 'ISpObjectToken',
    'DISPID_SOTCEnumerateTokens', 'SPLO_STATIC', 'eLEXTYPE_PRIVATE9',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SAStatus',
    'DISPID_SGRSTsCount', 'SpSharedRecoContext', 'STSF_AppData',
    'SPCT_DICTATION', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRRTTickCount', 'SRTAutopause', 'SpeechFormatType',
    'ISpEventSource', 'DISPIDSPTSI_ActiveOffset',
    'ISpeechRecoResultDispatch', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SPDKL_DefaultLocation', 'SREAudioLevel',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_PROPERTY_STRING_CHANGE',
    'SRADefaultToActive', 'SVSFUnusedFlags', 'SpeechVoiceSpeakFlags',
    'DISPID_SpeechGrammarRule', 'SVP_20', 'SPSHORTCUTPAIR',
    'DISPID_SPEsCount', 'DISPID_SRSCurrentStreamNumber', 'SVSFIsXML',
    'SITooFast', 'SpeechDiscardType', 'eLEXTYPE_RESERVED10',
    'SVEPrivate', 'DISPID_SRGCmdSetRuleState', 'SPPHRASEPROPERTY',
    'DISPID_SWFEBlockAlign', 'DISPID_SpeechRecoContext',
    'eLEXTYPE_RESERVED8', 'SLOStatic', 'SREPropertyNumChange',
    'DISPID_SGRSTNextState', 'ISpeechBaseStream', 'SREStreamEnd',
    'SAFT11kHz16BitMono', 'DISPID_SpeechPhraseProperties',
    'DISPID_SVEVoiceChange', 'ISpeechAudio', 'SPAS_CLOSED',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SWFEExtraData',
    'SPSERIALIZEDPHRASE', 'ISpeechLexiconWord', 'SpInprocRecognizer',
    'DISPID_SOTCreateInstance', 'DISPID_SGRsCount', 'SVP_5',
    'DISPID_SOTCategory', 'SPEI_RESERVED1',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechMemoryStream',
    'SRSEDone', 'DISPID_SDKEnumKeys', 'DISPID_SGRSTText',
    'SPWF_SRENGINE', 'ISpPhoneticAlphabetConverter',
    'SpeechStreamSeekPositionType', 'DISPID_SRSClsidEngine',
    'ISpShortcut', 'SpeechAddRemoveWord', 'SP_VISEME_3',
    'SPPS_RESERVED1', 'STSF_CommonAppData', 'SAFT11kHz16BitStereo',
    'ISpAudio', 'STCLocalServer', 'DISPID_SpeechPhraseRule',
    'ISpeechPhraseProperty', 'SPFM_OPEN_READWRITE',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_PRIVATE18',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_RESERVED3', 'eLEXTYPE_APP',
    'SWPKnownWordPronounceable', 'DISPID_SpeechRecognizer',
    'SGDSInactive', 'DISPID_SpeechPhraseRules', 'ISpeechLexiconWords',
    'SPVPRI_NORMAL', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRRTimes', 'SPEI_SOUND_START', 'SAFT44kHz8BitMono',
    'SP_VISEME_16', 'DISPID_SVIsUISupported', 'SPPHRASE',
    'SPEI_INTERFERENCE', 'SREStreamStart',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SpeechPhraseReplacement',
    'SWTAdded', 'SpeechTokenShellFolder', 'DISPID_SLPs_NewEnum',
    'DISPID_SRSNumberOfActiveRules', 'SpeechTokenKeyUI',
    'DISPID_SVGetVoices', 'SPAO_NONE', 'SRESoundStart',
    'SAFT12kHz8BitStereo', 'DISPID_SGRSAddRuleTransition',
    'SPSHT_EMAIL', 'SP_VISEME_13', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRCCreateResultFromMemory', 'SVSFParseSsml',
    'SDTReplacement', 'DISPID_SVRate', 'SVEAllEvents', 'SPSModifier',
    'ISpPhrase', 'DISPID_SVSInputSentenceLength',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SASetState',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SVStatus', 'SSFMOpenForRead',
    'DISPID_SVEWord', 'DISPID_SVAlertBoundary',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SVAudioOutput',
    'DISPID_SVWaitUntilDone', 'SPLEXICONTYPE', 'ISpeechGrammarRules',
    'SP_VISEME_17', 'DISPID_SpeechPhraseElements',
    'SPAO_RETAIN_AUDIO', 'ISpPhoneticAlphabetSelection',
    'SRCS_Disabled', 'SpStreamFormatConverter', 'SPGRAMMARWORDTYPE',
    'DISPID_SPIStartTime', 'SAFT16kHz8BitMono',
    'DISPID_SPERequiredConfidence', 'SVP_17', 'DISPID_SGRAttributes',
    'SpPhoneConverter', 'SREPropertyStringChange',
    'ISpeechPhraseElements', 'DISPID_SABufferInfo', 'SP_VISEME_2',
    'SpLexicon', 'DISPID_SpeechLexiconWords', 'DISPID_SPAs_NewEnum',
    'SPEI_REQUEST_UI', 'DISPID_SpeechLexiconWord',
    'DISPID_SRCEPhraseStart', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SpeechGrammarRules', 'DISPID_SRGetPropertyString',
    'SpeechRunState', 'DISPIDSPRG',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SDKLCurrentUser',
    'SITooLoud', 'SVP_2', 'DISPID_SPIReplacements', 'SP_VISEME_9',
    'DISPID_SPEDisplayAttributes', 'DISPID_SpeechObjectTokenCategory',
    'SAFTGSM610_22kHzMono', 'DISPID_SPRuleConfidence',
    'ISpeechRecoContext', 'DISPID_SPRDisplayAttributes',
    'SP_VISEME_15', 'DISPID_SRRAudioFormat', 'eLEXTYPE_MORPHOLOGY',
    'SPSNoun', 'DISPID_SVSLastStreamNumberQueued',
    'SpeechBookmarkOptions', 'SPEI_MIN_TTS', 'SPBO_TIME_UNITS',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCEventInterests', 'SPCATEGORYTYPE',
    'SpeechCategoryAppLexicons', 'SAFT48kHz16BitStereo',
    'SAFT48kHz8BitMono', 'DISPID_SLAddPronunciationByPhoneIds',
    'SP_VISEME_7', 'SPXMLRESULTOPTIONS', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SpeechVoice', 'SRCS_Enabled', 'DISPID_SPILanguageId',
    'DISPID_SBSWrite', 'DISPID_SPPsCount', 'DISPID_SPRulesCount',
    'SSFMCreate', 'SpeechCategoryVoices', 'SDTAll', 'DISPID_SOTId',
    'SVEEndInputStream', 'DISPID_SRCBookmark', 'SAFT11kHz8BitMono',
    'DISPID_SVEStreamEnd', 'DISPID_SRAudioInputStream',
    'eLEXTYPE_PRIVATE19', 'DISPID_SGRsCommitAndSave',
    'DISPID_SLWWord', 'SASPause', 'DISPID_SOTCId', 'DISPID_SRCVoice',
    'SVEStartInputStream', 'SPPARTOFSPEECH', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SDKEnumValues', 'SAFT8kHz8BitStereo',
    'DISPID_SGRsFindRule', 'SRTSMLTimeout', 'DISPID_SVPriority',
    'SPSNotOverriden', 'SpeechVoicePriority',
    'SpeechPropertyAdaptationOn', 'SpeechCategoryRecognizers',
    'DISPID_SRSSupportedLanguages', 'SAFT12kHz8BitMono', 'SPSVerb',
    'DISPID_SPPFirstElement', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SGRSRule', 'DISPID_SPEActualConfidence', 'SVP_10',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechAudioFormatType',
    'SPCONTEXTSTATE', 'SAFT44kHz16BitStereo', 'SAFTADPCM_11kHzMono',
    'SAFTNonStandardFormat', 'SVP_21', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SGRClear',
    'SPWORDPRONOUNCEABLE', 'SPSHT_NotOverriden',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SMSSetData',
    'DISPID_SGRSTRule', 'SREAllEvents', 'DISPID_SOTs_NewEnum',
    'SPCT_SLEEP', 'DISPID_SLGetPronunciations',
    'DISPID_SVSCurrentStreamNumber', 'SP_VISEME_19',
    'ISpeechWaveFormatEx', 'Speech_StreamPos_Asap',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SDKGetStringValue',
    'SAFT8kHz16BitMono', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCSetAdaptationData', 'SVPOver', 'DISPID_SAFGuid',
    'DISPID_SpeechAudioFormat', 'SAFT32kHz16BitMono',
    'DISPID_SPRsItem', 'SINoSignal', 'SP_VISEME_4', 'SpMMAudioEnum',
    'eLEXTYPE_RESERVED6', 'DISPID_SRGCmdLoadFromObject',
    'WAVEFORMATEX', 'SP_VISEME_6', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRCERecognition', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SDKSetBinaryValue', 'DISPID_SVSVisemeId',
    'ISpeechPhraseAlternates', 'SPDATAKEYLOCATION', 'ISpRecoContext',
    'SGDisplay', 'SpWaveFormatEx', 'SDKLLocalMachine',
    'DISPID_SOTGetStorageFileName', 'ISpeechRecoResult',
    '_RemotableHandle', 'DISPID_SOTDataKey', 'SSFMOpenReadWrite',
    ...
    'SPRST_ACTIVE_ALWAYS', 'SAFTCCITT_uLaw_8kHzStereo', 'SBONone',
    'ISpNotifyTranslator', 'SRAImport', 'SpeechTokenIdUserLexicon',
    'SDTRule', 'SPEI_MAX_SR', 'DISPID_SRRRecoContext',
    'DISPID_SREmulateRecognition', 'DISPID_SRCRetainedAudioFormat',
    'SGDSActiveWithAutoPause', 'SDTPronunciation',
    'SPPS_NotOverriden', 'DISPID_SPRuleParent',
    'SPEI_START_INPUT_STREAM', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SpeechObjectToken', 'DISPID_SDKDeleteKey',
    'SGRSTTDictation', 'SpeechAudioProperties',
    'SAFT24kHz16BitStereo', 'DISPIDSPTSI_ActiveLength',
    'SPINTERFERENCE_TOOQUIET', 'SAFT48kHz8BitStereo', 'SREAdaptation',
    'ISpRecognizer3', 'SAFT16kHz16BitMono', 'ISpSerializeState',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVP_3', 'SGRSTTEpsilon',
    'DISPID_SpeechRecoResult', 'SPXRO_SML', 'SVP_12',
    'DISPID_SPRuleChildren', 'SPPS_Noncontent', 'eWORDTYPE_ADDED',
    'SPRULE', 'DISPID_SRCVoicePurgeEvent', 'SPEI_VISEME',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPPNumberOfElements', 'ISpRecoContext2', 'SVEViseme',
    'ISpVoice', 'SAFTDefault', 'DISPID_SRProfile', 'SPAUDIOSTATUS',
    'DISPID_SVSkip', 'DISPID_SVSpeakStream', 'SPGS_EXCLUSIVE',
    'DISPID_SVSRunningState', 'SPINTERFERENCE_NONE', 'SRESoundEnd',
    'DISPID_SVEEnginePrivate', 'STSF_FlagCreate', 'SREStateChange',
    'SPVOICESTATUS', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SITooQuiet', 'DISPID_SPEDisplayText',
    'DISPID_SGRSAddWordTransition', 'DISPID_SASFreeBufferSpace',
    'SPPHRASEREPLACEMENT', 'ISpeechObjectTokens', 'SVSFNLPMask',
    'DISPID_SPEsItem', 'DISPID_SPIProperties',
    'DISPID_SLGenerationId', 'tagSPPROPERTYINFO',
    'ISpStreamFormatConverter', 'SPWT_PRONUNCIATION',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SMSGetData',
    'DISPID_SLPLangId', 'DISPID_SPCLangId', 'DISPID_SRCCreateGrammar',
    'SPWORDLIST', 'SPSMF_SAPI_PROPERTIES', 'DISPID_SLPType',
    'DISPID_SRCEEnginePrivate', 'SAFT32kHz8BitMono', 'DISPID_SVPause',
    'SPRULESTATE', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SVSFParseAutodetect', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechPhraseReplacements', 'SVSFIsFilename',
    'SPDKL_CurrentUser', 'ISpeechVoice', 'eLEXTYPE_USER', 'SRAExport',
    'SVP_19', 'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SGRSTPropertyId',
    'SREFalseRecognition', 'SAFT48kHz16BitMono',
    'DISPID_SpeechPhraseAlternates', 'SVP_4', 'SpUnCompressedLexicon',
    'SRADynamic', 'DISPID_SRCEAudioLevel', 'LONG_PTR',
    'DISPID_SMSALineId', 'SPEI_SOUND_END',
    'SpeechPropertyNormalConfidenceThreshold', 'SpeechInterference',
    'SREPhraseStart', 'DISPID_SVVolume', 'SPSEMANTICERRORINFO',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRGDictationLoad',
    'SP_VISEME_21', 'SLTApp', 'SPEI_SR_RETAINEDAUDIO', 'SVP_0',
    'SPEI_FALSE_RECOGNITION', 'SPAUDIOOPTIONS', 'DISPID_SAVolume',
    'ISpeechMMSysAudio', 'SPAR_Unknown', 'DISPID_SVEStreamStart',
    'SP_VISEME_0', 'DISPID_SRRGetXMLResult',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVF_None', 'SpeechAudioState',
    'STCInprocHandler', '_ISpeechVoiceEvents',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechAudioFormatGUIDWave', 'DISPID_SPIAudioSizeTime',
    'SpeechUserTraining', 'SAFTADPCM_11kHzStereo',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SGRs_NewEnum',
    'DISPID_SRAudioInput', 'DISPID_SPPName', 'SPEI_SENTENCE_BOUNDARY',
    'SPRST_INACTIVE_WITH_PURGE', 'IInternetSecurityMgrSite',
    'IEnumSpObjectTokens', 'SPSHT_OTHER', 'eLEXTYPE_RESERVED4',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPCPhoneToId',
    'DISPID_SRSAudioStatus', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SFSOpen', 'ISpeechObjectTokenCategory', 'SPFM_CREATE',
    'DISPID_SLPPartOfSpeech', 'SpeechTokenKeyFiles',
    'SpeechCategoryAudioIn', 'DISPID_SPEAudioSizeTime',
    'DISPID_SVGetAudioOutputs', 'DISPID_SMSAMMHandle',
    'DISPID_SLWLangId', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRCEHypothesis', 'SDA_One_Trailing_Space',
    'DISPID_SOTsCount', 'ISpRecognizer',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpVoice', 'ISpeechMemoryStream',
    'SpeechDataKeyLocation', 'DISPID_SRCESoundStart',
    'DISPID_SDKOpenKey', 'DISPID_SVESentenceBoundary',
    'ISpeechLexicon', 'SDTDisplayText', 'SPEI_TTS_PRIVATE',
    'SPXRO_Alternates_SML', 'SAFTCCITT_uLaw_44kHzStereo',
    'SP_VISEME_14', 'SPPS_Unknown', 'SpeechGrammarState', 'SASStop',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpGrammarBuilder',
    'SVEVoiceChange', 'DISPID_SpeechRecoResult2', 'DISPID_SFSClose',
    'DISPID_SpeechLexicon', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseAlternate', 'SSTTTextBuffer',
    'ISpeechObjectToken', 'DISPID_SVSInputWordLength',
    'SpeechRecoProfileProperties', 'SPFM_CREATE_ALWAYS',
    'SpeechAudioVolume', 'DISPID_SADefaultFormat', 'SASRun',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRCRequestedUIType',
    'DISPID_SOTCSetId', 'DISPID_SLPPhoneIds',
    'DISPID_SRGSetWordSequenceData', 'SPDKL_CurrentConfig',
    'SPINTERFERENCE_NOISE', 'DISPID_SPIEngineId', 'DISPID_SLWsItem',
    'DISPID_SGRsItem', 'SGSExclusive', 'DISPID_SWFEFormatTag',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SLWsCount', 'DISPID_SGRName',
    'SGLexical', 'ISpeechPhraseInfo', 'DISPID_SRCPause',
    'DISPID_SRCResume', 'SPAR_Medium',
    'DISPID_SPERetainedStreamOffset', 'ISpeechResourceLoader',
    'ISpeechCustomStream', 'SSTTWildcard', 'SVSFNLPSpeakPunc',
    'DISPID_SPRuleFirstElement', 'SVP_18', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRCERequestUI', 'DISPID_SDKDeleteValue',
    'SAFT32kHz8BitStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPAsItem', 'SVSFIsNotXML',
    'ISpeechPhraseElement', 'DISPID_SRGDictationUnload',
    'eLEXTYPE_USER_SHORTCUT', 'SPPS_RESERVED4', 'SINone',
    'SpeechRuleAttributes', 'DISPID_SPEAudioSizeBytes',
    'SpeechVoiceEvents', 'DISPID_SPRuleEngineConfidence',
    'SP_VISEME_10', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRRDiscardResultInfo', 'SPPS_Interjection',
    'SpeechPropertyResourceUsage', 'SITooSlow', 'DISPID_SPRs_NewEnum',
    'ISpeechPhraseInfoBuilder', 'DISPID_SpeechLexiconProns',
    'SPCS_ENABLED', 'SpCustomStream', 'ISpLexicon', 'UINT_PTR',
    'SpeechAudioFormatGUIDText', 'SRAONone', 'SPSInterjection',
    'SpeechRetainedAudioOptions', 'SpeechRecognitionType',
    'DISPID_SVSInputWordPosition', 'DISPID_SRIsShared',
    'SAFT22kHz8BitMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SASState', 'SVF_Stressed', 'SpTextSelectionInformation',
    'SPAUDIOBUFFERINFO', 'SAFT24kHz16BitMono', 'SSSPTRelativeToStart',
    'SPRECORESULTTIMES', 'SPGRAMMARSTATE', 'SGRSTTTextBuffer',
    'SPSLMA', 'DISPID_SAFType', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SpeechPhraseElement', 'SAFT22kHz16BitMono',
    'SPPS_RESERVED2', 'IEnumString', 'SAFT8kHz16BitStereo',
    'SPAR_High', 'DISPID_SOTRemoveStorageFileName',
    'SpeechTokenValueCLSID', 'SpResourceManager',
    'SPEI_WORD_BOUNDARY', 'DISPID_SLPSymbolic',
    'SAFTGSM610_11kHzMono', 'DISPID_SVEPhoneme', 'DISPID_SPRText',
    'ISpeechLexiconPronunciations', 'SAFTADPCM_44kHzMono',
    'DISPID_SRCRecognizer', 'SVP_16', 'SpeechPropertyResponseSpeed',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechGrammarRule',
    'SPEVENTENUM', 'SVSFVoiceMask', 'DISPID_SOTMatchesAttributes',
    'ISpPhraseAlt', 'SASClosed', 'SPEI_MAX_TTS', 'SPEI_HYPOTHESIS',
    'DISPID_SPIElements', 'ISpStreamFormat', 'DISPID_SVGetProfiles',
    '__MIDL_IWinTypes_0009', 'SECFEmulateResult', 'SpeechMicTraining',
    'SpMMAudioIn', 'SPGS_DISABLED', 'SPSHORTCUTPAIRLIST',
    'SPRECOCONTEXTSTATUS', 'SpeechRecoEvents',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpSharedRecognizer', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SpeechRecoResultTimes', 'SPWORDTYPE',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechLexiconPronunciation', 'SPWT_DISPLAY',
    'DISPID_SpeechPhraseInfo', 'eLEXTYPE_PRIVATE16',
    'SpeechPartOfSpeech', 'DISPID_SRCEAdaptation', 'SRERequestUI',
    'SVP_11', 'DISPID_SPPChildren', 'DISPID_SVSpeak',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPRulesItem',
    'SWPUnknownWordUnpronounceable', 'SVSFParseMask',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPPParent',
    'SWPUnknownWordPronounceable', 'ISpeechAudioBufferInfo',
    'SpeechGrammarTagDictation', 'SGPronounciation', 'SRTReSent',
    'SPAS_PAUSE', 'ISpeechAudioFormat', 'SPBO_AHEAD',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPRuleNumberOfElements',
    'SAFT44kHz8BitStereo', 'DISPIDSPTSI', 'DISPID_SPRules_NewEnum',
    'SDTLexicalForm', 'SVEBookmark', 'ISpeechDataKey',
    'DISPID_SLRemovePronunciation', 'SpeechTokenKeyAttributes',
    'DISPID_SRCEBookmark', 'DISPID_SGRInitialState',
    'DISPID_SABIEventBias', 'SpeechGrammarTagWildcard',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPVPRI_ALERT', 'SECHighConfidence',
    'SAFTCCITT_ALaw_22kHzMono', 'SpStream', 'DISPID_SOTGetAttribute',
    'SpeechRecognizerState', 'DISPID_SRGState',
    'DISPID_SWFEBitsPerSample', 'SpNotifyTranslator',
    'SPPROPERTYINFO', 'SAFT12kHz16BitStereo', 'SBOPause',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SpeechBaseStream',
    'ISpeechPhraseRule', 'DISPID_SPPValue', 'SREHypothesis',
    'DISPIDSPTSI_SelectionLength', 'SVSFPersistXML',
    'DISPID_SGRSTType', 'ISpObjectWithToken', 'SVSFlagsAsync',
    'DISPID_SGRSTPropertyValue', 'SPBINARYGRAMMAR', 'ISpDataKey',
    'SVP_8', 'DISPID_SRRTLength', 'SDA_Two_Trailing_Spaces',
    'eLEXTYPE_PRIVATE5', 'DISPID_SLPsCount', 'SDA_No_Trailing_Space',
    'DISPID_SRState', 'SpeechVisemeType', 'SVSFPurgeBeforeSpeak',
    'SSSPTRelativeToEnd', 'DISPID_SPIRetainedSizeBytes',
    'SAFT11kHz8BitStereo', 'SpeechPropertyComplexResponseSpeed',
    'SPEI_RESERVED6', 'SAFT24kHz8BitStereo', 'SpeechLexiconType',
    'SRTStandard', 'DISPID_SRRGetXMLErrorInfo', 'ISpRecognizer2',
    'ISpObjectTokenCategory', 'DISPID_SVSPhonemeId', 'SpeechWordType',
    'DISPID_SOTGetDescription',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSInputSentencePosition', 'SPINTERFERENCE',
    'SAFT16kHz8BitStereo', 'DISPID_SRGRules', 'SRSActive',
    'SPEI_RECO_STATE_CHANGE', 'SPCS_DISABLED', 'ISpProperties',
    'SPAUDIOSTATE', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRRSetTextFeedback', 'DISPID_SpeechAudioStatus',
    'Speech_Max_Pron_Length', 'SGDSActiveUserDelimited',
    'SPSFunction', 'DISPID_SRRSpeakAudio', 'DISPID_SRRTStreamTime',
    'DISPID_SPACommit', 'SPEI_PHRASE_START', 'SAFT8kHz8BitMono',
    'SAFT24kHz8BitMono', 'SLTUser', 'SPLO_DYNAMIC',
    'SAFTADPCM_8kHzStereo', 'ISpNotifySource', 'ISpRecoResult',
    'SPPS_LMA', 'SPLOADOPTIONS', 'STCRemoteServer',
    'DISPID_SPPs_NewEnum', 'SRTExtendableParse', 'DISPID_SRCState',
    'DISPID_SPEPronunciation', 'DISPID_SRCEPropertyNumberChange',
    'SPVPRI_OVER', 'SGRSTTRule', 'SPSTREAMFORMATTYPE'
]
